...
* **CyberChef**: For decoding, encoding, and analysing payloads and extracted data.
* **grep**: Built-in command-line tools for decoding payloads and processing log output.
* **ChatGPT**: Used to assist with analysis, documentation, and understanding investigation findings.
