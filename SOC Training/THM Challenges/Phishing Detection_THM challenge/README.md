...
This lab provided hands-on experience with the workflow of a Security Operations Center (SOC), including alert monitoring, phishing investigation, threat validation, and evidence-based incident response.
...
This simulation provided practical experience with core SOC responsibilities, including security monitoring, alert triage, phishing investigation, threat validation, and incident documentation.

It strengthened my ability to investigate phishing incidents using industry-standard tools while developing a structured, evidence-driven approach to security analysis.
