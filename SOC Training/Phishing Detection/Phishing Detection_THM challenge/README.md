...
➡️ I monitored similar alerts through the SIEM dashboard (see Screenshot 1)

🧠 Alert Triage

SOC Analysts determine whether alerts are real threats or false positives.

➡️ I analyzed each alert and made decisions based on evidence (see Screenshot 2)
...
➡️ I followed the same process during phishing analysis (see Screenshot 3 & 4)

🌐 Threat Intelligence Validation

SOC Analysts use external tools to confirm whether indicators are malicious.

➡️ I used VirusTotal to verify URLs and files (see Screenshot 5)

📝 Reporting

Clear documentation is critical in SOC roles.

➡️ I closed alerts with proper explanations and final verdicts (see Screenshot 6)
...
The Screeshots are there to verify it.
📊 Outcome
